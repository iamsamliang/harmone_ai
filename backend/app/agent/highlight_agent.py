...
def companion(user_input, yt_url, end_sec, context_len, reactor):
    ...
    transcript_segments = db_get_transcript(engine, yt_url, start_sec, end_sec)
    ...
    # Return the response content, audio response, and highlights' information

    return response.content, audio_resp, highlights_info
